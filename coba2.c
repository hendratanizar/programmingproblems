...
//di waktu program jalan, maka jalankan fungsi decrement dari si available resources, kemudian lakukan pengecekan apabila available resources nya kurang dari sama dengan 0 artinya sudah habis didecrement, maka lakukan pemanggilan fungsi increment available resources
